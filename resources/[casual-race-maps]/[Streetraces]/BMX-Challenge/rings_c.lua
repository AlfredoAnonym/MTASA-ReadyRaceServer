...
addEventHandler("onClientRender", root, function()
	-- mission failed text
	if failed then
		dxDrawBorderedText(1, "Mission Failed!", 0, 0, screenX, screenY*0.75, tocolor (156, 22, 25, 255), 3, "pricedown", "center", "center", true, false)
		dxDrawBorderedText(2, "You ran out of time!", 0, 0, screenX, screenY*0.98, tocolor (156, 22, 25, 255), 1.2, "bankgothic", "center", "bottom", true, false)
	end
