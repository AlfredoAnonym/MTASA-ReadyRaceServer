First off, you can test how it works on my server: mtasa://91.224.117.19:28060 (24/h server) - it shouldn't be put anywhere else, because it doesnt work like driving school (each player does the progress individually) it will work as coop for now. You can modify it however much you want. I'll try later to adapt it more to my server, adding a cool feature that will create Spectators team on "TAB" scoreboard, and then with onSpectateRequest it will warp all players from the server to spectators, and only 1 player from those players will be able to play the Paramedics mission and everyone else will watch, this will be my solution. If you know better solutions, you can modiy it however much you want.
